		...
		<tr>
			...
			<td class="td_leftnav_top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    ...
                    <tbody>
                        <c:forEach var="feedbackinfo" items="${feedbackinfoList }">
                        <tr>
                            <td class="td_main_list_content"></td>
                            <td class="td_main_list_content">${feedbackinfo.id }</td>
                            <td class="td_main_list_content">
                                <a href="companyDetail?id=${feedbackinfo.name }" hidefocus="true">${feedbackinfo.name }</a>
                            </td>
                            <td class="td_main_list_content">${feedbackinfo.relDate }</td>
                            <td class="td_main_list_content">${feedbackinfo.recieverStatus }</td>
                            <td class="td_main_list_content">
                            	<c:if test="${feedbackinfo.recieverStatus=='未提交'}">
									<a href="mgmt_r_cargo5b.htm" hidefocus="true">提交</a>
								</c:if>
								<c:if test="${feedbackinfo.recieverStatus=='待确认'}">
									<a href="mgmt_r_cargo5b.htm" hidefocus="true">查看</a>
								</c:if>
								<c:if test="${feedbackinfo.recieverStatus=='已确认'}">
									<a href="mgmt_r_cargo5b.htm" hidefocus="true">查看</a>
								</c:if>
                            </td>
                        </tr>
