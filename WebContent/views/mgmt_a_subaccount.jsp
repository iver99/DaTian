			...
			<td width="230" class="td_leftnav_top">
                <div id="main_frame_left">
                    ...
                    <div id="mgmt_nav5">
                        ...
                        <a href="mgmt_a_subaccount.htm" class="a_mgmt_leftnav1" hidefocus="true">附属帐户</a>
            ...
            <td class="td_leftnav_top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2">
					<tr>
                    	<td>
                            ...
                            <span class="span_mgmt_right2_text2"><a href="mgmt_a_subaccount2.htm" hidefocus="true"><img src="images/btn_add1.png" class="span_mgmt_right2_pic1" title="添加" /></a></span>
                            <div class="div_mgmt_s1">
                            	<input type="text" class="input_mgmt1" style="width:200px;" value="帐户名称..." />
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    ...
                    <tr>
                        ...
                        <td class="td_mgmt_right3_td1">abc-test1</td>
                        <td class="td_mgmt_right3_td1">2014-02-21<br />10:44:28</td>
                        <td class="td_mgmt_right3_td2">正常</td>
                        <td class="td_mgmt_right3_td3">
                            <div id="handlebox" style="z-index:203;">
                                <ul class="quickmenu">
                                    <li class="menuitem">
                                        <div class="menu">
                                            <a href="mgmt_a_subaccount4.htm" class="menuhd" hidefocus="true">查看</a>
                                            <div class="menubd">
                                                <div class="menubdpanel">
                                                    <a href="mgmt_a_subaccount3.htm" class="a_top3" hidefocus="true">更新</a>
                                                    <a href="javascript:;" class="a_top3" hidefocus="true">停用</a>
                    ...
                    <tr>
                        <td height="60" class="td_mgmt_right3_td1d">&nbsp;</td>
                        <td class="td_mgmt_right3_td1">abc-test2</td>
                        <td class="td_mgmt_right3_td1">2014-02-21<br />10:44:28</td>
                        <td class="td_mgmt_right3_td1">已停用</td>
                        <td class="td_mgmt_right3_td3">
                                    ...
                                    <li class="menuitem">
                                        <div class="menu">
                                            ...
                                            <div class="menubd">
                                                <div class="menubdpanel">
                                                    <a href="mgmt_a_subaccount3.htm" class="a_top3" hidefocus="true">更新</a>
                                                    <a href="javascript:;" class="a_top3" hidefocus="true">启用</a>
                                                    <a href="javascript:;" class="a_top3" hidefocus="true">删除</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <tr>
                        <td height="60" class="td_mgmt_right3_td1d">&nbsp;</td>
                        <td class="td_mgmt_right3_td1">abc-test3</td>
                        <td class="td_mgmt_right3_td1">2014-02-21<br />10:44:28</td>
                        <td class="td_mgmt_right3_td2">正常</td>
                        <td class="td_mgmt_right3_td3">
