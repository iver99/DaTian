                        ...
                        <td class="td_mgmt_right3_td1a">
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td><a href="images/illust_5.png" target="_blank" hidefocus="true"><img src="images/btn_filetype1.png" /></a></td>
                                </tr>
                            </table>
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
								    ...
								    <td><input type="submit" id="btn1" value="确认收货" class="btn_mgmt1" hidefocus="true" onclick="window.location.href='mgmt_d_order_s.htm'" /></td>
