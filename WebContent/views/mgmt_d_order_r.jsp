			...
			<td class="td_leftnav_top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    ...
                    <tr>
                        ...
                        <td class="td_mgmt_right3_td1"><a href="mgmt_d_order_r3.htm" hidefocus="true">${orderinfo.orderNum }</a></td>
                                ...
                                <ul class="quickmenu">
                                    <li class="menuitem">
                                        <div class="menu">
                                            ...
                                            <div class="menubd">
                                                <div class="menubdpanel">
                                                    <a href="mgmt_d_order_r4.htm" class="a_top3" hidefocus="true">查看</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <td class="td_mgmt_right3_td3">
                            <div id="handlebox" style="z-index:201;">
                                <ul class="quickmenu">
                                    <li class="menuitem">
                                        <div class="menu">
                                            <a href="mgmt_d_order_r6a.htm" class="menuhd" hidefocus="true">更新</a>
                                            <div class="menubd">
                                                <div class="menubdpanel">
                                                    <a href="mgmt_d_order_r4a.htm" class="a_top3" hidefocus="true">查看</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <td class="td_mgmt_right3_td3"><a href="mgmt_d_order_r4a.htm" hidefocus="true">查看</a></td>
                        </c:when>
                        
                        <c:when test="${orderinfo.state == '已完成' }">
                        <td class="td_mgmt_right3_td1">已完成</td>
                        <td class="td_mgmt_right3_td3"><a href="mgmt_d_order_r4b.htm" hidefocus="true">查看</a></td>
                        </c:when>
                        
                        <c:when test="${orderinfo.state == '已取消' }">
                        <td class="td_mgmt_right3_td1">已取消</td>
                        <td class="td_mgmt_right3_td3"><a href="mgmt_d_order_r3a.htm" hidefocus="true">查看</a></td>
                        </c:when>
