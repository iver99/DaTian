			...
			<tr>
				<td width="230" class="td_leftnav_top">
					<div id="main_frame_left">
						...
						<div id="mgmt_nav2">
							<div id="mgmt_nav2">
								<a href="mgmt_r_line.htm" class="a_mgmt_leftnav"
									hidefocus="true">干线运输线路信息</a> <a href="mgmt_r_city.htm"
									class="a_mgmt_leftnav" hidefocus="true">城市配送网络信息</a> <a
									href="mgmt_r_car.htm" class="a_mgmt_leftnav" hidefocus="true">车辆信息</a>
								<a href="mgmt_r_warehouse.htm" class="a_mgmt_leftnav"
									...
									class="a_mgmt_leftnav1" hidefocus="true">货物信息</a> <a
							...
							<div id="mgmt_nav5">
								<a href="mgmt_a_info.htm" class="a_mgmt_leftnav"
									hidefocus="true">帐户信息</a> <a href="mgmt_a_subaccount.htm"
									class="a_mgmt_leftnav" hidefocus="true">附属帐户</a> <a
									href="mgmt_a_address.htm" class="a_mgmt_leftnav"
									hidefocus="true">常用地址</a> <a href="mgmt_a_pwd.htm"
