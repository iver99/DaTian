                        ...
                        <td class="td_mgmt_right3_td1a">
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="input_mgmt1" style="width:100px;" name="actualPrice" value="${orderInfo.actualPrice }"/> (元)</td>
                                </tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">说明：</td>
									<td>
                                    	<textarea class="textarea_rating" placeholder="请输入内容..." name="explainReason">${orderInfo.explainReason }</textarea>
                                    </td>
								</tr>
								<tr>
