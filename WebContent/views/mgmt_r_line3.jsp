...
<%@ include  file="mysource_leftnav_top.jsp"%>
                    ...
                    <div id="mgmt_nav2">
                        <a href="linetransport?flag=1" class="a_mgmt_leftnav1" hidefocus="true">干线运输线路信息</a>
...
<%@ include  file="mysource_leftnav_bottom.jsp"%>                    
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    <tr>
                        <td class="td_mgmt_right3_td1a"> 
                            <br />
                            <form action="updateLine?id=${linetransportInfo.id }" method="post">	          
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="120" height="40" class="td_mgmt_right3_td1b">线路名称：</td>
                                    <td><input type="text" class="input_mgmt1" style="width:300px;" value="${linetransportInfo.startPlace }→${linetransportInfo.endPlace}" name="lineName"/></td>
                                </tr>
                                <tr>
      ...
      <input id="upload_btn4" type="file" onchange="document.getElementById('apply_attachment1').value=/[^\\]+\.\w+$/.exec(this.value)[0]" class="input_attachment_btn1_hidden" style="width:300px;" hidefocus="true" />
                                ...
                                <tr>
                                    ...
                                    <td><input type="submit" id="btn1" value="提交" class="btn_mgmt1" hidefocus="true" onclick="window.location.href='mgmt_r_line.htm'" /><input type="button" id="btn1" value="重填" class="btn_mgmt2" hidefocus="true" /></td>
                                </tr>
							</table>
							</form>
                        </td>
