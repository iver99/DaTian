						...
						<form action="insertClient" method="post" enctype="multipart/form-data">         
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="account"/></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">客户名称：</td>
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="clientName"/></td>
								</tr>
								<tr>
