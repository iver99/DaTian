						...
						<br />   	          
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="companyName"/></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">组织机构代码：</td>
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="divisionCode"/></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">法人姓名：</td>
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="legalName"/></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">法人身份证号：</td>
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="legalIDCard"/></td>
								</tr>
								<tr>
									<td height="40" class="td_mgmt_right3_td1b">公司地址：</td>
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="companyAddr"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="input_mgmt1" style="width:300px;" value="" name="companyContact"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
                                    	<textarea class="textarea_rating" placeholder="请输入内容..." name="basicSituation"></textarea>
                                    </td>
								</tr>								
								<tr>
