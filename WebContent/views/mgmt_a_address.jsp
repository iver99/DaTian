		...
		<tr>
			<td width="230" class="td_leftnav_top">
                <div id="main_frame_left">
                    ...
                    <div id="mgmt_nav5">
                        ...
                        <a href="mgmt_a_address.htm" class="a_mgmt_leftnav1" hidefocus="true">常用地址</a>
			...
			<td class="td_leftnav_top">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2">
                    <tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1">常用地址</span>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right3">
                    ...
                    <tr>
                        ...
                        <td class="td_mgmt_right3_td1">${address.name }</td>
                        <td class="td_mgmt_right3_td1">${address.address }</td>
                        <td class="td_mgmt_right3_td1">${address.phone }</td>
                        <td class="td_mgmt_right3_td1">${address.relDate }</td>
                        <td class="td_mgmt_right3_td3">
                            <div id="handlebox" style="z-index:203;">
                                <ul class="quickmenu">
                                    <li class="menuitem">
                                        <div class="menu">
                                            <a href="updateaddress?id=${address.id }" class="menuhd" hidefocus="true">更新</a>
                                            <div class="menubd">
                                                <div class="menubdpanel">
                                                    <a href="deleteaddress?id=${address.id }" class="a_top3" hidefocus="true">删除</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
