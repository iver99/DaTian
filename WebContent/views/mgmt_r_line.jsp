...
<body>
	...
	<div id="mgmt_nav2">
		<a href="linetransport?flag=1" class="a_mgmt_leftnav1"
		...
		<a href="client" class="a_mgmt_leftnav" hidefocus="true">客户信息</a> <a
			href="mgmt_r_cargo.htm" class="a_mgmt_leftnav" hidefocus="true">货物信息</a>
