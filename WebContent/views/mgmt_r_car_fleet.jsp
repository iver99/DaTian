		...
		<tr>
			<td width="230" class="td_leftnav_top">
                <div id="main_frame_left">
                    ...
                    <div id="mgmt_nav2">
                        ...
                        <a href="mgmt_r_car.htm" class="a_mgmt_leftnav1" hidefocus="true">车辆信息</a>
			...
			<td class="td_leftnav_top">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_mgmt_right2">
                    <tr>
                    	<td>
                        	<span class="span_mgmt_right2_text1"><a href="mgmt_r_car.htm" hidefocus="true">车辆信息</a>&nbsp;&nbsp;/&nbsp;&nbsp;车队信息&nbsp;&nbsp;/&nbsp;&nbsp;<a href="http://gps.dtw.com.cn:89/gpsonline" target="_blank" hidefocus="true">车队管理</a></span>
